    ...
    with cd("/opt/crpc"):
        with prefix("source /usr/local/bin/virtualenvwrapper.sh"):
            ...
            with prefix("workon "+ENV_NAME):
                ...
                run("pip install --upgrade zerorpc lxml requests pymongo mongoengine redis redisco pytz PIL mock selenium blinker cssselect boto python-dateutil virtualenvwrapper slumber esmre django"+USE_INDEX) 
