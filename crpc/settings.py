...
envs = {
    ...
    'TEST': {
        'CRAWLER_PEERS': [
            ...
            {'host_string':'root@ec2-54-245-22-46.us-west-2.compute.amazonaws.com', 'port':1236},
            {'host_string':'root@ec2-54-245-22-46.us-west-2.compute.amazonaws.com', 'port':12366},
        ],
        'POWER_PEERS': [
            ...
            {'host_string':'root@ec2-54-245-150-181.us-west-2.compute.amazonaws.com', 'port':1232},
            {'host_string':'root@ec2-54-245-150-181.us-west-2.compute.amazonaws.com', 'port':1233},
        ],
        'TEXT_PEERS': [
            ...
            {'host_string':'root@ec2-54-245-22-46.us-west-2.compute.amazonaws.com', 'port':1239},
        ],
        'USE_INDEX': '',
