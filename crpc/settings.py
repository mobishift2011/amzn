...
envs = {
    ...
    'INTEGRATE': {
        'CRAWLER_PEERS': [
            {'host_string':'root@ec2-54-244-171-130.us-west-2.compute.amazonaws.com', 'port':1234},
            {'host_string':'root@ec2-54-244-171-130.us-west-2.compute.amazonaws.com', 'port':12344},
            {'host_string':'root@ec2-54-244-198-50.us-west-2.compute.amazonaws.com', 'port':1235},
            {'host_string':'root@ec2-54-244-198-50.us-west-2.compute.amazonaws.com', 'port':12355},
        ],
        'POWER_PEERS': [
            {'host_string':'root@ec2-54-244-177-78.us-west-2.compute.amazonaws.com', 'port':1230},
            {'host_string':'root@ec2-54-244-177-78.us-west-2.compute.amazonaws.com', 'port':1231},
            {'host_string':'root@ec2-54-245-158-190.us-west-2.compute.amazonaws.com', 'port':1232},
            {'host_string':'root@ec2-54-245-158-190.us-west-2.compute.amazonaws.com', 'port':1233},
        ],
        'TEXT_PEERS': [
            {'host_string':'root@ec2-54-244-171-130.us-west-2.compute.amazonaws.com', 'port':1237},
            {'host_string':'root@ec2-54-244-198-50.us-west-2.compute.amazonaws.com', 'port':1238},
        ],
        'USE_INDEX': '',
