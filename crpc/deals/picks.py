...
class Picker(object):
	...
	def pick(self, product):
		...
		pp.clean()
		return pick_by_disfilter(product)
		# temp = '%s.^_^.%s' % (product.favbuy_brand, product.favbuy_dept)
		# return bool(DSFILTER.get(temp, {}))
