...
class Server:
    def __init__(self):
        self.logger_category = log.init('cabelas_category', 'cabelas_category.txt')
        self.logger_list = log.init('cabelas_list', 'cabelas_list.txt')
        self.logger_product = log.init('cabelas_product', 'cabelas_product.txt')
